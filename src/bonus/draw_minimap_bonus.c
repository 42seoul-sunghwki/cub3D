...
/*   Updated: 2024/04/27 19:33:00 by sunghwki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_minimap_routine(void *in)
{
	...
	{
		i = 0;
		minimap->start_x = minimap->mlx->minimap.w * minimap->start_y - minimap->start_y * minimap->start_y;
		minimap->end_x = 2 * minimap->mlx->minimap.w - minimap->start_x;
		//i = minimap->start_x;
		pixel_x = minimap->mlx->user.x - MINIMAP_SCALE / 2;
		while (i < minimap->mlx->minimap.w)
		{
