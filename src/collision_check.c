...
/*   Updated: 2024/04/09 13:12:38 by minsepar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	dir_y_check_p(t_map *map, t_user *user, double new_displacement_y)
{
	// printf("yp\n");
...
void	dir_y_check_n(t_map *map, t_user *user, double new_displacement_y)
{
	// printf("yn\n");
	// printf("y: [%f] x: [%f]\n", user->y + new_displacement_y + HITBOX, user->x);
	if (map->map[(int)(user->x - HITBOX)]
...
void	dir_x_check_p(t_map *map, t_user *user, double new_displacement_x)
{
	// printf("xp\n");
...
void	dir_x_check_n(t_map *map, t_user *user, double new_displacement_x)
{
	// printf("xn\n");
	// printf("y: [%f] x: [%f]\n", user->y, user->x + new_displacement_x - HITBOX);
	if (map->map[(int)(user->x + new_displacement_x - HITBOX)]
